...
| Metric                                                            | Description                                                                                                                  | Labels                                                                                      |
| ------                                                            | -----------                                                                                                                  | ------                                                                                      |
| *metrics.namespace*_service_binding_info                          | Labeled Cloud Foundry Service Binding information with a constant `1` value                                                  | `environment`, `deployment`, `sservice_binding_id`, `application_id`, `service_instance_id`, `route_binding_id` |
