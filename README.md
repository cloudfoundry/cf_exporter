...
| *metrics.namespace*_application_memory_mb | Cloud Foundry Application Memory (Mb) | `deployment`, `environment`, `application_id`, `application_name`, `organization_id`, `organization_name`, `space_id`, `space_name` |
