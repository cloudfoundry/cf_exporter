...
var (
	...
	filterCollectors = flag.String(
		"filter.collectors", "",
		"Comma separated collectors to filter (Applications,Organizations,Routes,SecurityGroups,ServiceInstances,Services,Spaces,Stacks) ($CF_EXPORTER_FILTER_COLLECTORS).",
	)
