...
The `filter.collectors` command flag allows you to filter what collectors will be enabled. Possible values are `Applications`, `Organizations`, `SecurityGroups`, `Services`, `Spaces` (or a combination of them).
